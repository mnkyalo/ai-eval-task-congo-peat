#!/usr/bin/env python3
"""Reference derivation, run INSIDE the verifier at grading time.
...
The raw data is sealed into the verifier image alongside this file, so the
answer is derived here rather than looked up, and nothing the agent can write
influences it.
"""
import csv
import json
